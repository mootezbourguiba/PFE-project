...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{assets/figures/chapter4/fig_current_temp_relationship.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{assets/figures/chapter4/fig_global_architecture.png}
